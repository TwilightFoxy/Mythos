...
public final class KitsuneAdornmentLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    private final com.twily.mythos.client.model.KitsuneAdornmentModel foxfireModel;
    ...
    public KitsuneAdornmentLayer(RenderLayerParent<AvatarRenderState, PlayerModel> renderer, EntityModelSet modelSet) {
        super(renderer);
        this.foxfireModel = new com.twily.mythos.client.model.KitsuneAdornmentModel(modelSet.bakeLayer(com.twily.mythos.client.model.KitsuneAdornmentModel.FOXFIRE_LAYER));
    }
